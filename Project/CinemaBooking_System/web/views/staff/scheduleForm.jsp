...
<%
    ...
    request.setAttribute("pageTitle", isEdit ? "✏️ Chỉnh sửa Lịch Chiếu" : "➕ Thêm Lịch Chiếu Mới");
%>
<!DOCTYPE html>
<html lang="vi">
    <head>
    ...
    <body>
        ...
        <header>
            <h1><%= isEdit ? "✏️ Chỉnh sửa Lịch Chiếu" : "➕ Thêm Lịch Chiếu Mới" %></h1>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <small style="color: #6b7280; margin-top: 5px; display: block;">
                                ⚠️ Thời gian bắt đầu phải sau hiện tại ít nhất 30 phút
                            </small>
                        </div>
