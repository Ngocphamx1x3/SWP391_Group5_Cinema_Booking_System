        ...
        <div class="content">
            ...
            <div class="stats-container">
                <div class="stat-box">
                    ...
                    <div class="stat-change">Tổng vé của tất cả các rạp</div>
                </div>
                <div class="stat-box">
                    ...
                    <div class="stat-change">Doanh thu của tất cả các rạp</div>
                </div>
                <div class="stat-box">
                    <h3>Rạp hoạt động</h3>
                ...
                <div class="stat-box">
                    ...
                    <div class="stat-change">Các phim đang chiếu hiện tại</div>
                </div>
                <div class="stat-box">
                    <h3>Người dùng</h3>
                    <div class="stat-value">${totalUsers}</div>
                    <div class="stat-change">Tổng số lượng người dùng</div>
                </div>
            </div>
                ...
                <script>
                    ...
                    if (labels.length === 0) {
                        document.getElementById('monthlyRevenueChart').insertAdjacentHTML(
                                'beforebegin',
                                '<p style="color:red">Không có dữ liệu doanh thu để hiển thị!</p>'
                                );
                    } else {
            ...
            <h2 class="section-title"> lịch chiếu gần đây</h2>
